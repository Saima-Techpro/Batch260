...
public enum Cities {
   ...
   You don't fetch it from a website, which could be down.
    ...
    // CITIES => constant and  (plateCode, cityName, postalCode) are the values
    ...
    // constructor is required to initialise the variables, but we can't create objects from enums.
    ...
    // Use getters to give access to these variable (Read only)
